...
export default function DriverAuth({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020617] px-6">
      ...
      <div className="absolute left-[-120px] top-[-120px] h-[300px] w-[300px] rounded-full bg-cyan-500/10 blur-[120px]" />

      <div className="absolute bottom-[-120px] right-[-120px] h-[300px] w-[300px] rounded-full bg-blue-500/10 blur-[120px]" />
      ...
      >
        ...
        <div className="mt-8 border-t border-white/5 pt-6 text-center">
          ...
          <p className="text-xs leading-relaxed text-slate-500">
            ...
            e política de segurança operacional da FRETOGO.
          </p>
