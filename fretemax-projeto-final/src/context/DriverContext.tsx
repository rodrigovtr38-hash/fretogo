...
const DriverContext =
  createContext<DriverContextData | undefined>(
    undefined,
  );
...
const DRIVER_RUNTIME_STORAGE =
  'fretmax_driver_runtime';
...
export function DriverProvider({
  ...
  useEffect(() => {
    try {
      ...
      if (
        parsed?.currentFreight !== undefined
      ) {
        setCurrentFreightState(
          parsed.currentFreight,
        );
      }

      if (
        parsed?.securityCode !== undefined
      ) {
        setSecurityCodeState(
          parsed.securityCode,
        );
      ...
      console.error(
        'DRIVER_CONTEXT_HYDRATION_ERROR',
        error,
      );
    }
  }, []);
  ...
  useEffect(() => {
    try {
      ...
      console.error(
        'DRIVER_CONTEXT_PERSISTENCE_ERROR',
        error,
      );
    }
  }, [
